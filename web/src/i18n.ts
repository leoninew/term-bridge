  ...
  'en-US': {
    ...
    dashboard: {
      ...
      cloudConnectionConnectedDescription:
        'This local device has completed Cloud authorization and can be seen by the cloud account.',
      cloudConnectionNotConnectedDescription:
        'This local device is not connected to Cloud yet; this is not a local sign-in state.',
      cloudConnectionPublicUrl: 'Cloud',
