...
export const messages = {
  'zh-CN': {
    ...
    gateway: {
      ...
      setupSigningIn: '正在完成本地访问授权…',
      setupFailed: '本地访问授权失败',
      setupMissingTokenTitle: '需要本地访问链接',
      setupMissingTokenDescription: '请使用 TermBridge 启动时显示的本地访问链接打开此页面。',
      setupMissingTokenHint: '本地浏览器访问通过一次性 setup token 换取 local_access 凭据。',
      setupBackToLogin: '使用账号登录',
      connectTitle: '连接当前设备到 Cloud Gate',
      connectDescription: '确认本地访问后，将当前设备公钥登记到固定 Cloud Gate。',
  ...
  'en-US': {
    ...
    gateway: {
      ...
      setupSigningIn: 'Completing local access setup…',
      setupFailed: 'Local access setup failed',
      setupMissingTokenTitle: 'Local access link required',
      setupMissingTokenDescription:
        'Open this page using the local access link shown when TermBridge started.',
      setupMissingTokenHint:
        'Local browser access uses a one-time setup token to create a local_access credential.',
      setupBackToLogin: 'Use account sign-in',
      connectTitle: 'Connect this device to Cloud Gate',
      connectDescription:
        'After local access is confirmed, this device public key will be registered with the configured Cloud Gate.',
