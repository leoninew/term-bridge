...
export const messages = {
  'zh-CN': {
    ...
    gateway: {
      ...
      agentLoginDescription:
        '当前 Web 运行在 agent mode，Agent dashboard 和 workbench 不需要 TermBridge 账号认证。账号登录请在 Cloud 完成。',
      agentLoginBackToDashboard: '返回 Agent dashboard',
      agentLoginConnectCloud: '连接云端账号',
      connectTitle: '连接当前设备到 Cloud',
      connectDescription: '将当前设备连接到固定 Cloud，完成云端账号授权后返回本机。',
      connectCloud: '连接 Cloud',
      connectingCloud: '正在跳转 Cloud…',
      connectSucceeded: '当前设备已连接到 Cloud。',
      connectFailed: '连接 Cloud 失败',
    ...
    dashboard: {
      ...
      agentHomeTitle: '本机工作台',
      localUser: '当前用户',
      projectVersion: '项目版本',
      agentWorkspaceListTitle: '工作区列表',
      cloudHomeTitle: 'Cloud 首页',
      openCloudDashboard: '进入 Dashboard',
      cloudLandingTitle: 'TODO：等待首页主标题',
      cloudLandingCopyTodo: 'TODO：等待首页主文案',
      cloudHeroImageAlt: 'TermBridge Cloud 首页主视觉占位',
      cloudLandingSlotPrimary: 'TODO：等待主入口说明',
      cloudLandingSlotPrimaryTodo: 'TODO：等待主入口文案',
      cloudLandingSlotSecondary: 'TODO：等待辅助入口说明',
      cloudLandingSlotSecondaryTodo: 'TODO：等待辅助入口文案',
      cloudLandingSlotTertiary: 'TODO：等待状态说明',
      cloudLandingSlotTertiaryTodo: 'TODO：等待状态文案',
      ...
      agentDeviceDescription:
        'Agent mode 不要求浏览器登录。你可以直接进入 Agent workbench，或连接 Cloud 后让云端账号看到这台设备。',
      ...
      cloudModeDescription: '连接 Cloud，让云端账号看到并管理这台本机设备。',
      cloudModeDisabledDescription: '请先配置 Cloud OAuth client 后再连接云端账号。',
  ...
  'en-US': {
    ...
    gateway: {
      ...
      agentLoginDescription:
        'This web runtime is in agent mode. The Agent dashboard and workbench do not require a TermBridge account. Complete account sign-in on Cloud instead.',
    ...
    dashboard: {
      ...
      agentHomeTitle: 'Local workspace',
      localUser: 'Current user',
      projectVersion: 'Project version',
      agentWorkspaceListTitle: 'Workspaces',
      cloudHomeTitle: 'Cloud Home',
      openCloudDashboard: 'Open Dashboard',
      cloudLandingTitle: 'TODO: waiting for landing headline',
      cloudLandingCopyTodo: 'TODO: waiting for landing copy',
      cloudHeroImageAlt: 'TermBridge Cloud landing visual placeholder',
      cloudLandingSlotPrimary: 'TODO: waiting for primary entry note',
      cloudLandingSlotPrimaryTodo: 'TODO: waiting for primary entry copy',
      cloudLandingSlotSecondary: 'TODO: waiting for secondary entry note',
      cloudLandingSlotSecondaryTodo: 'TODO: waiting for secondary entry copy',
      cloudLandingSlotTertiary: 'TODO: waiting for status note',
      cloudLandingSlotTertiaryTodo: 'TODO: waiting for status copy',
      ...
      agentDeviceDescription:
        'Agent mode does not require browser sign-in. Open the Agent workbench directly, or connect Cloud so your cloud account can see this device.',
      ...
      switchToCloudMode: 'Switch to Cloud mode',
      ...
      cloudGateNotConfigured: 'Cloud connection is not configured.',
      ...
      connectGuideDescription:
        'Open the Agent dashboard on the machine you want to add, then start Cloud authorization from there.',
      connectStepServe: 'Start termbridge agent on the target machine.',
      connectStepCloud:
        'From the Agent dashboard, open the Cloud connection flow and authorize with this cloud account.',
