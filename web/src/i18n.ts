...
export const messages = {
  'zh-CN': {
    ...
    dashboard: {
      ...
      cloudLandingTitle: '从云端进入在线 Agent 的工作台',
      cloudLandingCopy:
        'Cloud 是账号与设备路由入口：先确认当前账号可访问的 Agent，再进入该设备上的 workspace、session 和 terminal。',
      cloudHeroImageAlt: 'TermBridge Cloud 设备路由与 Agent 工作台示意',
      cloudSignInCta: '登录 Cloud 账号',
  ...
  'en-US': {
    ...
    dashboard: {
      ...
      cloudLandingTitle: 'Open an online Agent from Cloud',
      cloudLandingCopy:
        'Cloud is the account and routing layer: confirm the Agents available to this account, then open the selected device’s workspaces, sessions, and terminals.',
      cloudHeroImageAlt: 'TermBridge Cloud device routing and Agent workbench overview',
