...
export const messages = {
  'zh-CN': {
    ...
    gateway: {
      ...
      online: '在线',
      offline: '离线',
      offlineReadonly: '设备离线：仅可读取已缓存历史，不能写入或附加终端。',
      offlineReadonlyTitle: '设备离线只读',
      attachOnly: '设备离线：仅可读取已缓存历史，不能写入或附加终端。',
      attachOnlyTitle: '设备离线只读',
      selectExistingSession: '选择已有会话查看历史；设备离线时只能读取已缓存历史。',
  ...
  'en-US': {
    ...
    gateway: {
      ...
      offlineReadonlyTitle: 'Device offline read-only',
      attachOnly:
        'Device offline: cached history is read-only; writes and terminal attach are unavailable.',
