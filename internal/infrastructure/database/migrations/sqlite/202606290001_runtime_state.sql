...
CREATE INDEX idx_sessions_current_run ON sessions(current_run_id);
...
CREATE INDEX idx_session_runs_session_deleted ON session_runs(session_id, deleted_at);
CREATE INDEX idx_session_runs_workspace_deleted ON session_runs(workspace_id, deleted_at);
CREATE INDEX idx_session_runs_device_deleted ON session_runs(device_id, deleted_at);
