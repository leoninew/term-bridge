...
func TestCORSNoopWhenNotConfigured(t *testing.T) {
	recorder := serveCORSRequest(t, nil, http.MethodGet, "/local-api/health", "https://app.example.com")
...
func TestCORSAllowsSingleOrigin(t *testing.T) {
	recorder := serveCORSRequest(t, []string{"https://app.example.com"}, http.MethodGet, "/local-api/health", "https://app.example.com")
...
func TestCORSAllowsMultipleOrigins(t *testing.T) {
	recorder := serveCORSRequest(t, []string{"https://app.example.com", "https://preview.example.com"}, http.MethodGet, "/local-api/health", "https://preview.example.com")
...
func TestCORSDeniedPreflightReturnsForbidden(t *testing.T) {
	recorder := serveCORSRequest(t, []string{"https://app.example.com"}, http.MethodOptions, "/local-api/health", "https://evil.example.test")
...
func TestCORSIgnoresRequestsWithoutOrigin(t *testing.T) {
	recorder := serveCORSRequest(t, []string{"https://app.example.com"}, http.MethodOptions, "/local-api/health", "")
